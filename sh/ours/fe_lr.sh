...
for init_lr in 0.01
do
for fe_lr in 0.005 0.01 0.05
do
for cnn in '7 14' #'7 14 30'
do
...
for dkl_layers in 0
do
for init_lr in 0.005 0.01 0.05
do
for fe_lr in 0.01
do
...
for MTL_method in 'equal' # 'dwa' 'uncert' 'gradnorm' 'pcgrad'
do
CUDA_VISIBLE_DEVICES=0 /mlainas/teang1995/anaconda3/envs/mogp/bin/python debug.py \
--init_lr ${init_lr} \
--fe_lr ${fe_lr} \
--kernel_jp 'SM+P' \
--kernel_kr 'SM+L' \
