...
do
for kernel_name in 'SML+P' 'SM+P' 'SM+L' 'SM+P+L'  'SpectralMixture' 'SML' 'SMPL' 'SMP' 'SMP+L' 
do
...
do
CUDA_VISIBLE_DEVICES=1 /mlainas/teang1995/anaconda3/envs/mogp/bin/python ours.py \
--max_epoch ${max_epoch} \
--tolerance ${tolerance} \
--init_lr ${init_lr} \
